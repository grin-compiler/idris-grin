...
--  it "TDD 02 - 01 Average" $ idris "test/tdd/chapter02/01_Average.idr" -- Read from stdin
  it "TDD 02 - 03 Prelude" $ idris "test/tdd/chapter02/03_Prelude.idr"
  it "TDD 03 - 01 Matrix" $ idris "test/tdd/chapter03/01_Matrix.idr"
--  it "TDD 04 - 01 Data Types" $ idris "test/tdd/chapter04/01_DataTypes.idr" -- Differences in floating point
--  it "TDD 04 - 02 Data Store" $ idris "test/tdd/chapter04/02_DataStore.idr" -- Read from stdin
